...
class KWPFramework {
	...
	private static $assetsPath = '/administrator/components/com_kwpsolarsystem/assets';
	...
	public static function getInlineCss() {
		...
		$assets = '<link rel="stylesheet" href="' . Uri::root(true) .  'administrator/components/com_kwpsolarsystem/assets/css/kwpframework.css" type="text/css" />';
	...
	public static function getInlineJs() {
		...
		$assets = '<script src="' . Uri::root(true) . 'administrator/components/com_kwpsolarsystem/assets/js/kwpframework.js" type="text/javascript"></script>';
