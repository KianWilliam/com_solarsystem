...
use Joomla\Component\Kwpsolarsystem\Administrator\Helper\KwpinputHelper;
use Joomla\Component\Kwpsolarsystem\Administrator\Helper\KwptextHelper;
...
class KwpfofHelper {
	...
	static protected $environment = 'com_kwpsolarsystem'; // for joomla only

	static protected $input;

	public static function loadHelper($name) {
		require_once(JPATH_SITE . '/administrator/components/com_kwpsolarsystem/helper/Kwp' . $name . '.php');
	}
...
//			, $db->quoteName('profile_key') . ' = ' . $db->quote('custom.%')
	...
	public static function getModel($modelName, $classPrefix = 'Kwpsolarsystem') {
