<?php 
/*
  * @package component kwpsolarsystem for Joomla! 5.x 6.x, 6.x
...
//require_once Uri::Base() . 'components/com_kwpsolarsystem/forms/helper.php';
//exit();
...
//class JFormFieldKwpslidesmanager extends FormField {
	class KwpslidesmanagerField extends FormField {
	...
	protected function getInput() {
		...
		$rootvars="
		var KWPuri, KWPSOLARSYSTEMTOKEN, URIBASE, BASEURL,SITEROOT;
				SITEROOT = '".Uri::Base()."';
	...
	//	require_once(JPATH_ROOT . '/administrator/components/com_carouselck/helpers/defines.js.php');
		...
		HTMLHelper::_('script', $path.'admin.js');
				HTMLHelper::_('script', $path.'sortable.js');
