...
use Joomla\Component\Kwpsolarsystem\Administrator\Extension\KwpsolarsystemComponent;
...
return new class implements ServiceProviderInterface
{
	...
	{
		$container->registerServiceProvider(new MVCFactory('\\Joomla\\Component\\Kwpsolarsystem'));
		$container->registerServiceProvider(new ComponentDispatcherFactory('\\Joomla\\Component\\Kwpsolarsystem'));
        $container->registerServiceProvider(new RouterFactory('\\Joomla\\Component\\Kwpsolarsystem'));

        $container->set(
            ComponentInterface::class,
            function (Container $container)
            {
                $component = new KwpsolarsystemComponent($container->get(ComponentDispatcherFactoryInterface::class));
