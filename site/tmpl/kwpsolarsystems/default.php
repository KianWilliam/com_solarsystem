...
<?php endif; ?>
<form action="<?php echo Route::_('index.php?option=com_kwpsolarsystem&view=kwpsolarsystems'); ?>" method="get" name="adminForm" id="adminForm">
    ...
    <div class="table-responsive">
            ...
            <thead>
                <tr>
                    <th class="item-created_by">
						<?php echo HTMLHelper::_('grid.sort',  'COM_KWPSOLARSYSTEM_HEADING_FRONTEND_LIST_KWPSOLARSYSTEMS_CREATED_BY', 'a.created_by', $listDirn, $listOrder); ?>
					</th>
                </tr>
            </thead>
            <tbody>
        ...
        <input type="hidden" name="view" value="kwpsolarsystems" />
        <input type="hidden" name="option" value="com_kwpsolarsystem" />
