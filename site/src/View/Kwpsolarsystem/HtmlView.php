...
namespace Joomla\Component\Kwpsolarsystem\Site\View\Kwpsolarsystem;
...
class HtmlView extends BaseHtmlView
{
    ...
    private function hasAccess(): bool
    {
        ...
        if($this->_layout == 'edit') {
            ...
            if ($isEdit) {
                $authorised = $user->authorise('core.edit', 'com_kwpsolarsystem');
                $access = new AccessHelper();
                $access->preloadOwnRecords('#__kwpsolarsystem_kwpsolarsystems');
                if ($access->canAccessOwnRecord()) {
                    return true;
                }
            } else {
                $authorised = $user->authorise('core.create', 'com_kwpsolarsystem');
            }
            if ($authorised !== true) {
