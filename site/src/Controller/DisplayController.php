...
namespace Joomla\Component\Kwpsolarsystem\Site\Controller;
...
class DisplayController extends BaseController
{
	...
	public function display($cachable = false, $urlparams = false)
	{
		...
		$vName = $this->input->get('view', 'Kwpsolarsystems');
		$this->input->set('view', $vName);

		if ($user->get('id') || ($this->input->getMethod() === 'POST' && $vName === 'Kwpsolarsystems')) {
			$cachable = false;
		}
        ...
        Factory::getLanguage()->load('com_kwpsolarsystem', JPATH_ADMINISTRATOR, 'en-GB', true);
